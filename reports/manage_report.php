<?php 
if(isset($_GET['id'])){
    $qry = $conn->query("SELECT * FROM `report` where id = '{$_GET['id']}'");
    if($qry->num_rows > 0){
...
<div class="content py-3">
    <div class="card card-outline card-primary rounded-0 shadow">
        <div class="card-header">
            <h5 class="card-title"><b><?= isset($id) ? "Update Report" : "New Report" ?></b></h5>
        </div>
        <div class="card-body">
            <form action="" id="article-form">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="invite" class="label-control-label">Report Document</label>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <label for="image" class="label-control-label">Geo-Tag Image</label>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="custom-control custom-checkbox">
                          ...
                          <label for="status" class="custom-control-label">Publish Report</label>
                        </div>
                    </div>
                </div>
			...
			$.ajax({
				...
				success:function(resp){
					if(typeof resp =='object' && resp.status == 'success'){
						...
						location.replace("./?page=reports/view_report&id="+resp.aid)
