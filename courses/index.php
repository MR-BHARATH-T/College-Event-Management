                    ...
                    <div class="card-body">
                        ...
                        <div class="my-2 list-group ml-5">
                          <?php 
                              ...
                              $courses = $conn->query("SELECT *, d.name as department FROM `course_list` c inner join department_list d on c.department_id = d.id where c.delete_flag = 0 and c.`status` = 1 and c.department_id = '{$drow['id']}' order by c.`name` asc");
