			...
			<table class="table table-hover table-striped table-bordered" id="list">
				...
				<tbody>
					...
					$i = 1;
						...
						$qry = $conn->query("SELECT a.*, u.username as writer,u.department as dept from `report` a inner join users u on a.user_id = u.id where a.delete_flag = 0 {$uwhere} order by a.`title` asc ");
