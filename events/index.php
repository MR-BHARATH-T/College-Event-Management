...
<div class="card card-outline rounded-0 card-primary">
        ...
        <div class="container-fluid">
			<table class="table table-hover table-striped table-bordered" id="list">
				...
				<tbody>
					...
					// 	}
						$qry = $conn->query("SELECT a.*, u.username as writer,u.department as dept from `event` a inner join users u on a.user_id = u.id where a.delete_flag = 0 order by a.`title` asc ");
    ...
    ?>
    <a href="<?= $u ?>" target="_blank">View Invitation</a>
</td>
						</tr>
					<?php endwhile; ?>
				</tbody>
