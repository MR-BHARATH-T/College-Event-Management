...
<div class="container-fluid">
	<form action="" id="department-form">
		...
		<div class="form-group">
			<label for="d_name" class="control-label">Name</label>
			<input type="text" name="d_name" id="d_name" class="form-control form-control-sm rounded-0" value="<?php echo isset($d_name) ? $d_name : ''; ?>"  required/>
		</div>
		<div class="form-group">
