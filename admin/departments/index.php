        ...
        <div class="container-fluid">
			<table class="table table-hover table-striped table-bordered" id="list">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT * from `department_list` where delete_flag = 0 order by `d_name` asc ");
...
<script>
	$(document).ready(function(){
		...
		$('.save_data').click(function(){
			_conf("Successfully Added New Department","save_department",[$(this).attr('data-id')])
		})
